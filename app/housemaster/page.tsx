...
export default async function HousemasterDashboardPage({searchParams}:{searchParams:Promise<{gender?:string}>}) {
  ...
  const actions=[
    ...
    ['Exeat','Manage temporary leave permissions for Boarders.','/housemaster/exiat','fa-person-walking-arrow-right','bg-amber-100 text-amber-700'],
